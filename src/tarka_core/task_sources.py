...
# NOTE: CR-004 removed create_clarification_point_task and complete_clarification_point_task
# Clarifications are now created directly as tasks with task_type='clarification'
# No sync adapter needed anymore
